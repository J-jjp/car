...
public:
    ...
    Mapping(const cv::Size &origSize, const cv::Size &dstSize)
    {
        ...
        m_origPoints.clear();
        // [第二版无带畸变镜头参数]
        m_origPoints.push_back(Point2f(20, 239));   // 左下
        m_origPoints.push_back(Point2f(300, 239)); // 右下
        m_origPoints.push_back(Point2f(200, 0));   // 右上
        m_origPoints.push_back(Point2f(120, 0));   // 左上
